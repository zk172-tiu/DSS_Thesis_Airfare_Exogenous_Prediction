...
def tune_random_forest(X_train, y_train, n_trials=30, n_splits=3, n_jobs=2):
    ...
    def objective(trial):
        ...
        for train_idx, val_idx in kf.split(X_train):
            ...
            # Predictions are back-transformed if the target was log-transformed
    ...
    # Initialise Optuna study with pruning based on median values
...
def main():
    ...
    y_train = df['Fare_log']  # log-transformed target
