...
cat_features = [
    ...
    'route', 'airline_route', 'duration_bin'
]
...
best_params = {
    'iterations': 1600, 
    'depth': 9, 
    'learning_rate': 0.08340077986755062, 
    'l2_leaf_reg': 3.038459843704982, 
    'random_strength': 0.41969464384077826, 
    'bagging_temperature': 0.7373149292267109, 
    'border_count': 128,
    'loss_function': 'MAE',
    'task_type': 'GPU',
    'random_seed': 42,
